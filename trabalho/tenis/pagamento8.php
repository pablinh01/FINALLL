    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#sobrealoja">Contato</a></li>
            </ul>
        </nav>
    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <label for="size">Numeração da Blusa</label>
                    <select id="size" name="size" required>
                        <option value="" disabled selected>Selecione o tamanho</option>
                        <option value="37" disabled>PP - indisponivel</option>
                        <option value="38" disabled>P - indisponivel</option>
                        <option value="39">M</option>
                        <option value="40">G</option>
                        <option value="41">GG</option>
                        <option value="42" disabled>XG - indisponivel</option>
                        <option value="43" disabled>XGG - indisponivel</option>
                ...
                <div class="form-group">
                    <p class="total-price">Total: R$ <span id="total-price">332.4</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/0285640LA2.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/0285640LA15.jpg" alt="Imagem 2">
                    <img src="https://imgnike-a.akamaihd.net/768x768/0285640LA4.jpg" alt="Imagem 3">
                    <img src="https://imgnike-a.akamaihd.net/768x768/0285640LA14.jpg" alt="Imagem 4">
                </div>
            ...
            <div class="product-description">
                <h1>Camisa Nike Brasil I 2024/25 Torcedor Pro Masculina</h1>
                <h2>Detalhes do produto</h2>
                <p>
                    A nova camisa do Brasil 2024 apresenta uma textura completa que celebra a vasta herança natural e
                    cultural do país e sua história de brilhantismo dentro de campo. Da música às araras, do Pão de
                    Açúcar às praias mundialmente famosas, todo o Brasil está contido neste padrão de textura rica. <br> <br>

                    O escudo está de volta ao seu lugar. Assim como na lendária camisa de 2004, o escudo da CBF está na
                    frente e no centro da nova camisa do Brasil 2024.
                </p>
            </div>
        </div>
    </div>
