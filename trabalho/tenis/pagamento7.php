        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02872151A8.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02872151A1.jpg" alt="Imagem 2">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02872151A3.jpg" alt="Imagem 3">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02872151A4.jpg" alt="Imagem 4">
                </div>
            ...
            <div class="product-description">
                <h1>Camisa Nike Corinthians I 2024/25 Torcedor Pro Masculina</h1>
                <h2>Detalhes do produto</h2>
                <p>
                    Fundado por operários, a história do Corinthians se mistura com a história negra, carregando na sua
                    essência a luta pelos trabalhadores, pela democracia e pelo povo.
                </p>
            </div>
        </div>
    </div>
