    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <p class="total-price">Total: R$ <span id="total-price">408.4</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02654551A8.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02654551A1.jpg"
                        alt="Imagem 2">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02654551A5.jpg" alt="Imagem 3">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02654551A6.jpg" alt="Imagem 4">
                </div>
            ...
            <div class="product-description">
                <h1>Blusão Nike Barcelona FC Club Fleece Masculino</h1>
                <h2>Detalhes do produto</h2>
                <p>
                Pegamos um clássico do dia a dia e o infundimos
                com o orgulho do FC Barcelona para criar um básico
                confortável que você vai querer usar de novo e de
                novo. Feito de French terry de peso médio que é
                macio por fora com laços não escovados por dentro,
                este moletom relaxado é respirável e confortável o
                suficiente para usar o ano todo, não importa a
                temperatura.
                </p>
            </div>
        </div>
