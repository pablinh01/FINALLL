    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <p class="total-price">Total:R$ <span id="total-price">759,99</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/026709N2A8.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/026709N2A4.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/026709N2A5.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/026709N2A1.jpg" alt="Imagem 1">
                </div>
            ...
            <div class="product-description">
                <h1>Tênis Nike Infinity Run 4 Feminino</h1>
                <h2>Detalhes do produto</h2>
                <p>
                    Com amortecimento de suporte feito para uma corrida macia, o Infinity 4 ajuda você a correr no
                    asfalto. Feito com espuma Nike ReactX macia a confortável para impulso adicional e atualizado com o
                    Flyknit de melhor ajuste da Nike Running já criado, este corredor para o asfalto ajuda você a
                    decolar a qualquer hora, em qualquer lugar sem todo aquele atrito de desgaste. É o tipo de tênis que
                    pode proporcionar a você aquela tranquilidade inestimável para ir mais rápido e mais longe, graças
                    às pilhas de espuma altas e um design intuitivo que suporta cada passada.
                </p>
            </div>
        </div>
    </div>
