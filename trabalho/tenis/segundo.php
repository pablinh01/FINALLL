    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <p class="total-price">Total:$ <span id="total-price">1499,99</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02825551A8.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02825551A1.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02825551A3.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02825551A4.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/02825551A5.jpg" alt="Imagem 1">
                </div>
            ...
            <div class="product-description">
                <h1>Air Max Plus III</h1>
                <h2>Detalhes do produto</h2>
                <p>
                    Apresentando a icônica tecnologia Tuned Air de seus antecessores, o Nike Air Max Plus 3 atualiza o
                    visual com TPU fundido à parte superior em couro sintético aveludado. Em homenagem ao OG, apresenta
                    cores nítidas e contrastantes que lhe dão uma vantagem sobre a concorrência.
                </p>
            </div>
        </div>
    </div>
