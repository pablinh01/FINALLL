    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <p class="total-price">Total: R$ <span id="total-price">349.9</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="https://imgnike-a.akamaihd.net/768x768/029054NXA1.jpg" alt="Imagem 1">
                    <img src="https://imgnike-a.akamaihd.net/768x768/029054NXA2.jpghttps://imgnike-a.akamaihd.net/768x768/029054NXA2.jpg"
                        alt="Imagem 2">
                    <img src="https://imgnike-a.akamaihd.net/768x768/029054NXA4.jpg" alt="Imagem 3">
                    <img src="https://imgnike-a.akamaihd.net/768x768/029054NXA5.jpg" alt="Imagem 4">
                </div>
            ...
            <div class="product-description">
                <h1>Camiseta Nike Liverpool Dri-FIT Academy Pro Masculina</h1>
                <h2>Detalhes do produto</h2>
                <p>
                    Após dominar o básico, leve suas habilidades a
                    outro nível. Um caimento tradicional clássico se
                    combina com a tecnologia que absorve a umidade
                    para ajudar a manter seu corpo fresco quando o
                    treino esquenta
                </p>
            </div>
        </div>
